...
sudo apt install git vim tmux libx11-dev libxtst-dev zip make gcc 
# don't need pocketchip
...
# don't need PocketDESK
#cd
#git -c http.sslVerify=false clone https://git.nytpu.com/forks/PocketDesk
